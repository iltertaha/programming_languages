...
public:
    ...
    void setAverageLapTime(int val);
    void sortall();
    int getFastestPoint(Car * car) const;
    void swap(int index1, int index2);
    int fastestoflap(Car * car)const;
    int rankingpoint(Car * car)const;
    std::string kacinci(Car * ptr)const;
    Car* getCarHead() const;
};
