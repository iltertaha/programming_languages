...
/**
    ...
    Laptime operator[](const int lap) const;
     ...
     void removeone(Laptime* prevNode);
     void removeafter(Laptime* ptr);
     Laptime* getLapHead() const;
     void setLapHead(Laptime* lapp);
     void setPerformance(int val);
     std::string kisalt(const Car& car)const;
};
